            ...
            <div className="relative z-10 flex h-full w-full items-center justify-center">
                ...
                {state === 'thinking' && (
                    <div className="absolute -bottom-1 flex items-center gap-1">
                        <div className="h-1.5 w-1.5 animate-bounce rounded-full bg-white" style={{ animationDelay: '0ms' }} />
                        <div className="h-1.5 w-1.5 animate-bounce rounded-full bg-white" style={{ animationDelay: '150ms' }} />
                        <div className="h-1.5 w-1.5 animate-bounce rounded-full bg-white" style={{ animationDelay: '300ms' }} />
                    </div>
                )}
            </div>
        </div>
